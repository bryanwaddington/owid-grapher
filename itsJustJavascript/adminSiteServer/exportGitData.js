...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const dataset of yield Dataset_1.Dataset.find({ namespace: "owid" })) {
        if (!dataset.isPrivate)
            yield gitDataExport_1.syncDatasetToGitRepo(dataset.id, { commitOnly: true });
    }
    yield db.closeTypeOrmAndKnexConnections();
});
main();
//# sourceMappingURL=exportGitData.js.map