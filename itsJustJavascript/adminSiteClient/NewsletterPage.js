    ...
    render() {
        ...
        return (React.createElement("tr", null,
            React.createElement("td", null,
                React.createElement("img", { src: post.imageUrl, style: { width: "120px" } })),
            React.createElement("td", null,
                React.createElement("h2", null,
                    React.createElement("a", { href: post.url }, post.title)),
...
let NewsletterPage = class NewsletterPage extends React.Component {
    constructor() {
        super(...arguments);
        this.posts = [];
    ...
    get searchIndex() {
        ...
        for (const post of this.posts) {
            searchIndex.push({
                post: post,
                term: fuzzysort_1.default.prepare(post.title),
            });
        }
        return searchIndex;
    }
    ...
    render() {
        ...
        return (React.createElement(AdminLayout_1.AdminLayout, { title: "Newsletter" },
            React.createElement("main", { className: "NewsletterPage" },
    ...
    getData() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (admin.currentRequests.length > 0)
                return;
            const json = yield admin.getJSON("/api/newsletterPosts.json");
            mobx_1.runInAction(() => {
...
NewsletterPage.contextType = AdminAppContext_1.AdminAppContext;
__decorate([
    mobx_1.observable
], NewsletterPage.prototype, "posts", void 0);
__decorate([
    mobx_1.observable
], NewsletterPage.prototype, "maxVisibleRows", void 0);
__decorate([
    mobx_1.observable
], NewsletterPage.prototype, "searchInput", void 0);
__decorate([
    mobx_1.observable
], NewsletterPage.prototype, "availableTags", void 0);
__decorate([
    mobx_1.computed
], NewsletterPage.prototype, "searchIndex", null);
__decorate([
    mobx_1.computed
], NewsletterPage.prototype, "postsToShow", null);
__decorate([
    mobx_1.computed
], NewsletterPage.prototype, "numTotalRows", null);
__decorate([
    mobx_1.action.bound
], NewsletterPage.prototype, "onSearchInput", null);
__decorate([
    mobx_1.action.bound
], NewsletterPage.prototype, "onShowMore", null);
