...
exports.isPathRedirectedToExplorer = exports.getExplorerRedirectForPath = exports.explorerRedirectTable = void 0;
...
exports.explorerRedirectTable = new CoreTable_1.CoreTable(explorerRedirectTableMatrix);
const standardizePath = (path) => !path.startsWith("/") ? `/${path}` : path;
const getExplorerRedirectForPath = (path) => {
    path = standardizePath(path);
    return exports.explorerRedirectTable.rows.find((redirect) => redirect.path === path);
};
exports.getExplorerRedirectForPath = getExplorerRedirectForPath;
const isPathRedirectedToExplorer = (path) => exports.explorerRedirectTable.get("path").uniqValuesAsSet.has(standardizePath(path));
exports.isPathRedirectedToExplorer = isPathRedirectedToExplorer;
//# sourceMappingURL=ExplorerRedirects.js.map