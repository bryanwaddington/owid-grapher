...
const MultiColorPolyline_1 = require("../scatterCharts/MultiColorPolyline");
it("splits different-colored segments", () => {
    const points = [
        { x: 0, y: 0, color: "#000" },
        { x: 1, y: 0, color: "#111" },
    ];
    const segments = MultiColorPolyline_1.getSegmentsFromPoints(points);
...
//# sourceMappingURL=MultiColorPolyline.test.js.map