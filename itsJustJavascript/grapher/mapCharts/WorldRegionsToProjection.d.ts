export declare enum WorldRegionToProjection {
    Abkhazia = "Asia",
    Afghanistan = "Asia",
...
export declare type WorldRegionName = keyof typeof WorldRegionToProjection;
//# sourceMappingURL=WorldRegionsToProjection.d.ts.map