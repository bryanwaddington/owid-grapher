...
const config = (env, argv) => __awaiter(void 0, void 0, void 0, function* () {
    const isProduction = argv.mode === "production";
    // baseDir is necessary to make webpack.config.ts use the correct path both in TS as well as in
    // transpiled JS form
    const baseDir = path_1.default.basename(__dirname) === "itsJustJavascript"
        ? path_1.default.resolve(__dirname, "..")
        : __dirname;
    const javascriptDir = path_1.default.resolve(baseDir, "itsJustJavascript");
    return {
        ...
        output: {
            path: path_1.default.join(javascriptDir, "webpack"),
            filename: "[name].js",
        },
        resolve: {
            extensions: [".js", ".css"],
        ...
        plugins: [
            ...
            new webpack_1.default.IgnorePlugin(/settings\/(serverSettings|clientSettingsReader)/),
