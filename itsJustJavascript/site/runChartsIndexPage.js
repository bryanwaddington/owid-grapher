...
exports.runChartsIndexPage = void 0;
...
class ChartFilter {
    constructor() {
        ...
        this.sections = Array.from(document.querySelectorAll(".ChartsIndexPage main .content section"));
        const lis = Array.from(document.querySelectorAll(".ChartsIndexPage main .content li"));
        this.chartItems = lis.map((li) => ({
            title: li.children[0].textContent.replace(/₂/g, "2"),
            li: li,
            ul: li.closest("ul"),
        }));
    ...
    render() {
        ...
        for (const c of this.chartItems) {
            ...
            if (!res) {
                ...
                c.li.style.display = "";
                c.li.children[0].innerHTML = (_a = FuzzySearch_1.highlight(res)) !== null && _a !== void 0 ? _a : "";
            }
        }
