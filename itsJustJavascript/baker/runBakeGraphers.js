 ...
 */
const main = (folder) => __awaiter(void 0, void 0, void 0, function* () {
    yield GrapherBaker_1.bakeAllChangedGrapherPagesVariablesPngSvgAndDeleteRemovedGraphers(folder);
});
const dir = process.argv.slice(2).join(" ");
main(dir);
//# sourceMappingURL=runBakeGraphers.js.map